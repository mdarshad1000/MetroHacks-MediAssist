...
let symptomsWrapper = document.getElementById("symptomsWrapper");
...
function addField(element){
    ...
    input.setAttribute("id", "symptoms")
    input.setAttribute("placeholder", "Enter query or symptoms");
    ...
    minus.setAttribute("class", "buttons");
    let minusText = document.createTextNode("−");
    minus.appendChild(minusText);

    symptomsWrapper.insertBefore(div, symptomsWrapper.lastChild);
